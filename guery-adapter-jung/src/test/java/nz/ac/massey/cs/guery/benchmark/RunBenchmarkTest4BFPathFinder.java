 ...
 */
public class RunBenchmarkTest4BFPathFinder {
	...
	private static InputStream load(String resource) throws Exception {
		return RunBenchmarkTest4BFPathFinder.class.getResourceAsStream("/test/nz/ac/massey/cs/guery/benchmark/"+resource);
	}
}
