...
/**
 * Runs a benchmark test for nz.ac.massey.cs.guery.adapters.jungalt.JungAdapter.
 * Analyses azureus for instances of cd.guery (defined in this package).
 * Results will be printed to the console.
 * @author jens dietrich
 */
public class RunBenchmarkTest4JungAltAdapter {
	...
	public static void main(String[] args) throws Exception {
		...
		engine.query(new nz.ac.massey.cs.guery.adapters.jungalt.JungAdapter<TypeNode, TypeRef>(graph),motif,coll,ComputationMode.ALL_INSTANCES);
	...
	private static InputStream load(String resource) throws Exception {
		return RunBenchmarkTest4JungAltAdapter.class.getResourceAsStream("/test/nz/ac/massey/cs/guery/benchmark/"+resource);
	}
}
