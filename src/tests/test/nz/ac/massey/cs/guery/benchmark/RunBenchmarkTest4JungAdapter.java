...
/**
 * Runs a benchmark test for nz.ac.massey.cs.guery.adapters.jung.JungAdapter.
 * Analyses azureus for instances of cd.guery (defined in this package).
 * Results will be printed to the console.
 * @author jens dietrich
 */
public class RunBenchmarkTest4JungAdapter {
	...
	private static InputStream load(String resource) throws Exception {
		return RunBenchmarkTest4JungAdapter.class.getResourceAsStream("/test/nz/ac/massey/cs/guery/benchmark/"+resource);
	}
}
