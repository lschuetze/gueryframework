...
public class DefaultMotif<V extends Vertex<E>,E extends Edge<V>> implements Motif<V,E> {
	
	private List<String> roles = new ArrayList<String>();
	private List<String> pathRoles = new ArrayList<String>();
	private List<String> negatedPathRoles = new ArrayList<String>();
	private String name = null;
	private List<GroupByClause<V>> groupByClauses = new ArrayList<GroupByClause<V>>();
	private List<Processor<V,E>> graphProcessors = new ArrayList<Processor<V,E>>();
	...
	@Override
	public List<GroupByClause<V>> getGroupByClauses() {	
		return groupByClauses;
	}
	public void setGroupByClauses(List<GroupByClause<V>> groupBy){
		this.groupByClauses = groupBy;
	}
	@Override
	public List<Processor<V,E>> getGraphProcessors() {
		return graphProcessors;
	}
	public void setGraphProcessor(List<Processor<V,E>> processors){
